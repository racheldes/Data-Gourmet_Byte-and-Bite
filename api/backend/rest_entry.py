...
from backend.programmer.programer_routes import programmer
...
def create_app():
    ...
    app.config['MYSQL_DATABASE_DB'] = 'ByteBite'.strip()  # Change this to your DB name
    ...
    # pr for post becasue p for review is already used
